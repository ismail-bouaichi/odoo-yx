    ...
    def _unlink_property_sub_project(self):
        ...
        for rec in self:
            if rec.property_unit_ids:
                raise ValidationError(_("Cannot delete subproject, please delete "
...
class ProjectImagesLine(models.Model):
    ...
    def _compute_can_image_1024_be_zoomed(self):
        ...
        for image in self:
            image.can_image_1024_be_zoomed = image.image and is_image_size_above(image.image, image.image_1024)
