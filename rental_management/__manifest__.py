...
# Part of TechKhedut. See LICENSE file for full copyright and licensing details.
{
    ...
    'data': [
        ...
        'wizard/subproject_creation_view_inherit.xml',
        'wizard/unit_creation_view.xml',
        'wizard/agreement_preview_view.xml',
        # Payment schedule wizards (must load before property_vendor_view)
        'views/payment_schedule_views.xml',
        'views/payment_justification_wizard_views.xml',
        'views/payment_schedule_generate_wizard_views.xml',
        # Views
        'views/assets.xml',
        ...
        'views/property_project_view_inherit.xml',
        'views/property_sub_project_views.xml',
        'views/rent_bill_view.xml',
        'views/templates/property_web_template.xml',
        'views/property_presale_views.xml',
        'views/property_presale_wizard_views.xml',
        'views/property_booking_inherit_presale_block.xml',
        # Inherit Views
        ...
        # menus
        'views/menus.xml',
        # Hide rental features (Sales Only mode)
        'views/hide_rent_features.xml',
        # Add Residential & Commercial property type labels
        'views/property_type_residential_commercial.xml',
    ],
    'assets': {
        'web.assets_backend': [
