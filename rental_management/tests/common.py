...
class CreateRentalData(TransactionCase):
    ...
    def _create_units_wizard(
        ...
        return (cls.env["unit.creation"].with_context(
            active_id=active_id, unit_from=unit_from).create({"total_floors": total_floors,
    ...
    def _create_sub_project_wizard(
        ...
        return cls.env["subproject.creation"].with_context(
            active_id=active_id).create({"name": name,
    ...
    def _create_units(
        ...
        return cls.env["property.details"].create({"name": name, "property_seq": property_seq,
    ...
    def _create_service(cls, name, is_extra_service_product: bool,
        ...
        return cls.env["product.product"].create({"name": name,
    ...
    def _create_extra_service(cls, service_id, service_type, property_id):
        return cls.env["extra.service.line"].create({"service_id": service_id,
    ...
    def _create_booking_wizard(
        ...
        return cls.env["booking.wizard"].with_context(
            active_id=active_id).create({"customer_id": customer_id,
                                         "property_id": property_id,
    ...
    def _create_duration(cls, duration: str, month: int, rent_unit: str, ):
        return cls.env["contract.duration"].create({"duration": duration,
                                                    "month": month,
                                                    "rent_unit": rent_unit,
                                                    })
    ...
    def _create_installment_wizard(cls, active_id, company_id=None,
        ...
        return cls.env["property.vendor.wizard"].with_context(
            active_id=active_id).create({"company_id": company_id,
    ...
    def _create_property_payment_wizard(
        ...
        return cls.env["property.payment.wizard"].with_context(
            active_id=active_id).create({"tenancy_id": tenancy_id,
                                         "customer_id": customer_id,
    ...
    def _create_contract_service_line(
        ...
        return cls.env["contract.service.line"].create({"rent_contract_id": rent_contract_id,
                                                        "service_id": service_id,
                                                        "currency_id": currency_id,
    ...
    def _create_agreement_template(
        ...
        return cls.env["agreement.template"].create({"name": name,
                                                     "company_id": company_id,
                                                     "agreement": agreement,
    ...
    def _create_region(
        ...
        return cls.env["property.region"].create({"name": name,
                                                  "city_ids": city_ids,
